function plot_assort_nodesvar(areas,filter,condition)
%% plot_assort_nodesvar
%
%   Plotting assortativity varing in function of nodes across of animals 
%experiments.
%Inputs:
%
%Areas,Filter, Condition
%
%Outputs:
%
% 2 plots
...
%Addition notes
%
%Remember : load('AxN.mat')
%
%Structure of inputs:
%_______AxN (assortativity x nodes)
%____________Areas
%___________________PFC, PPC,SI, VI
%____________Filter
%___________________alpha, gam
...
%
%PFC , PPC, SI , VI
%PFC and SI have one more rat sample - condition: 0
%PPC and VI haven't it - condition: 1



%cd ([ 'C:\Users\CAUA\Documents\IINELS\Research\Small project\Pre-data\data' areas '_' filter ])
cd ([ 'C:\Users\CAUA\Documents\IINELS\Research\Small project\Pre-data\data\PFC_alpha'])
...
load('r6-xn-e1.mat')
load('r6-xn-e0.mat')
plot(x_nodos1,y_ass1, '-o','color', 'y')
plot(x_nodos2,y_ass2, '-*','color','y')
lgd= legend('Rat 1 - E0','Rat 1 - E1','Rat 2 - E0','Rat 2 - E1','Rat 3 - E0', 'Rat 3 - E1','Rat 4 - E0','Rat 4 - E1','Rat 5 - E0','Rat 5 - E1','Rat 6 - E0','Rat 6 - E1', 'Location','southeast');
end
...
if condition==0
load('rat6.mat','animalPerformance')
ap=[ap, animalPerformance];
end
